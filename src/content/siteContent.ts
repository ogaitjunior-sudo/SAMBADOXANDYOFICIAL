export const siteContent = {
  ...
  hero: {
    eyebrow: "Show ao vivo em destaque",
    title: "Samba do Xandy",
    subtitle:
      "Imersão de palco, luz, público cantando junto e a energia de um show real abrindo o site desde o primeiro segundo.",
    primaryAction: {
    ...
    secondaryAction: {
      ...
      href: "https://www.youtube.com/@Sambadoxandy",
    },
  },
  socialProof: [
    "Vídeo principal abrindo a experiência",
    "Presença de palco e clima de evento premium",
    "Contato rápido para reservas e produção",
  ],
  events: [
    {
      date: "02 MAI",
      ...
      location: "Rancho Aristides Ribeiro (Fazenda Juliana, 7 km de Ribeira do Pombal/BA)",
      ctaLabel: "Solicitar orçamento",
    },
    {
      date: "10 MAI",
      weekday: "Domingo",
      title: "Cavalgada das Mães",
      time: "16h",
      city: "Tucano, BA",
      location: "Tucano/BA",
      ctaLabel: "Solicitar orçamento",
  ...
  artistShowcase: {
    ...
    integrantes: {
      title: "A música que você ouve começa aqui.",
      description:
